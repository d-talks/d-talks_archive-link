  ...
  <div class="root">
    ...
    <div class="module-card radius-6 yh">
      ...
      <div class="card-contents">
        ...
        <div
          class="icon-favicon"
          :style="{ background: '~/assets/img/icon/pinter-100x100.png' }"
        ></div>
      </div>
...
.module-card.yh .card-contents {
    padding: 40px 14px;
    position: relative;
}
.module-card.yh .text-title {
    font-size: 18px;
    font-weight: bold;
    color: #000000;
    margin-bottom: 10px;
}
.module-card.yh .text-sub {
    font-size: 14px;
    font-weight: normal;
    color: #000000;
}
.module-card.yh .icon-favicon{
    width: 50px;
    height: 50px;
    border-radius: 15px;
    overflow: hidden;
...
.module-card.yh .card-footer {
    padding: 0 14px 14px;
    position: relative;
}
.module-card.yh .text-writer {
    font-size: 12px;
    font-weight: bold;
    line-height: 30px;
}
.module-card.yh .text-by {}
.module-card.yh .text-name {}
.module-card.yh .module-text-icon{
    position: absolute;
    top: 0;
    right: 14px;
}
